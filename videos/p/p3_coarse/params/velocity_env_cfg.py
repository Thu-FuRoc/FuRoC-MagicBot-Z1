...
COBBLESTONE_ROAD_CFG = terrain_gen.TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        "random_grid": terrain_gen.MeshRandomGridTerrainCfg(proportion=0.3, grid_width=0.6, grid_height_range=(0.0, 0.25)),
    },
)
@configclass
...
class RewardsCfg:
    ...
    base_height = RewTerm(func=mdp.base_height_l2, weight=-6.0, params={"target_height": 0.7})
    ...
    joint_mirror = RewTerm(func=mdp.joint_mirror, weight=-0.3, params={"asset_cfg": SceneEntityCfg("robot"), "mirror_joints": [["left_hip_pitch_joint", "right_hip_pitch_joint"], ["left_hip_roll_joint", "right_hip_roll_joint"], ["left_hip_yaw_joint", "right_hip_yaw_joint"], ["left_knee_joint", "right_knee_joint"], ["left_ankle_pitch_joint", "right_ankle_pitch_joint"], ["left_ankle_roll_joint", "right_ankle_roll_joint"]], "joint_weights": [1.0, 1.0, 1.0, 1.5, 3.0, 1.0]})
