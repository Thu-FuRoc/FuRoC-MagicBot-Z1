...
生成文件位置： - `tmp/phase_configs/p3b_coarse/velocity_env_cfg.py` — 地形 + reward - `tmp/phase_configs/p3b_coarse/ppo_override_cfg.py` — PPO 参数
...
Generated from launch_training.md